    ...
    <el-dialog
      ...
      >
        ...
        <el-form-item label="活动展示图：" prop="imageUrlsArray">
          <multi-upload v-model="activityData.imageUrlsArray" @multiClearValidate="multiClearValidate" @clearMultiArray="clearMultiArray"></multi-upload>
        </el-form-item>
...
<script>
  import {fetchListAll as fetchActivityTypeListAll} from 'network/englishActivityType'
  ...
  export default {
    ...
    methods:{
      ...
      handleAdd(){
        ...
        this.isEdit = false;
        this.activityData = Object.assign({}, defaultActivityData);
        try{
      ...
      clearMultiArray(fileList){
        //清空imageUrl
        console.log(fileList);
        this.activityData.imageUrlsArray = [];
        for(let i=0;i<fileList.length;i++){
          this.activityData.imageUrlsArray.push(fileList[i].url);
        }
      },
      tinyClearValidate(){
      ...
      handleUpdate(index,row){
        ...
        if(this.activityData.imageUrls != null && this.activityData.imageUrls != ''){
          // this.activityData.imageUrlsArray = this.activityData.imageUrls.split(',');
