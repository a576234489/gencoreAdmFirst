  ...
  export default {
    ...
    methods:{
      ...
      initFinancingAlreadyOptions(){
        fetchFinancingAlreadyListAll({type:2}).then(res => {
      ...
      initFinancingMainBodyOptions(){
        fetchFinancingMainBodyListAll({type:2}).then(res => {
      ...
      initFinancingDemandOptions(){
        fetchFinancingDemandListAll({type:2}).then(res => {
      ...
      initProjectTypeOptions(){
        fetchProjectTypeListAll({type:2}).then(res => {
